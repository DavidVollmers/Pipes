...
function ResourcePattern({ mouseX, mouseY, ...gridProps }) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#A5F3FC] to-[#C4B5FD] opacity-0 transition duration-300 group-hover:opacity-100 dark:from-[#155E75] dark:to-[#5B21B6]"
        style={style}
      />
      <motion.div
