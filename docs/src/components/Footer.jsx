...
const FeedbackThanks = forwardRef(function FeedbackThanks(_props, ref) {
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-sky-50/50 py-1 pr-3 pl-1.5 text-sm text-sky-900 ring-1 ring-inset ring-sky-500/20 dark:bg-sky-500/5 dark:text-sky-200 dark:ring-sky-500/30">
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 dark:border-white/5 sm:flex-row">
      ...
      <div className="flex gap-4">
        <SocialLink
          href="https://github.com/DavidVollmers/Pipes"
          icon={GitHubIcon}
        >
          Follow us on GitHub
        </SocialLink>
